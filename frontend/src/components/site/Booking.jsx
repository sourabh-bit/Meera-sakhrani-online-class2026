      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12">
        ...
        <div className="mt-14 md:mt-16 max-w-5xl mx-auto">
          <div
            ...
            className="bg-[#f1e2d8] border border-[#e3d2c8] rounded-sm p-7 md:p-9"
            style={{
              backgroundImage:
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-start">
              ...
              <div className="bg-[#eee4d8] border border-[#dfd2c4] rounded-sm p-6 md:p-8 text-center flex flex-col items-center justify-center min-h-full">
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#f5ede7] flex items-center justify-center">
                ...
                <button
                  ...
                  className="mt-7 w-full max-w-xs px-8 py-3.5 rounded-full bg-[#7a6455] text-[#f5ede7] text-[11px] tracking-[0.32em] uppercase font-semibold hover:bg-[#5b4a40] transition-all shadow-[0_12px_28px_-14px_rgba(124,90,110,0.55)]"
                >
                  Pay Securely
                </button>
