      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12">
        <div className="flex items-center justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 md:px-7 py-2.5 md:py-3.5 rounded-full border border-[#2d2326]/30 text-[#2d2326] text-[10px] md:text-[11px] tracking-[0.28em] md:tracking-[0.32em] uppercase font-semibold hover:bg-[#2d2326] hover:text-[#f5ede7] transition-all whitespace-nowrap"
          >
            View Portfolio
