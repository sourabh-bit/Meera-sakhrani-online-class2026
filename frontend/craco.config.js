...
webpackConfig.devServer = (devServerConfig) => {
  // Remove deprecated webpack-dev-server v4 keys not supported in v5
  ...
  delete devServerConfig.reporter;
  delete devServerConfig.noInfo;
  delete devServerConfig.quiet;
